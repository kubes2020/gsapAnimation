...
runThree
    ...
    // third person down
    .to(tpBody, { duration: 4, y: 80, ease: Power2.easeInOut }, "thirdperson")
...
runText
    // text appears
    .from(hi, { duration: 0.15, x: -800, ease: "power4" }, "thirdperson+=1.7")
    ...
    .to(coach, { duration: 0.1, scale: 2, ease: "power4" }, "thirdperson+=1.8")
    .to(
        chelsea,
